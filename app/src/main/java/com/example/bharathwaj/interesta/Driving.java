...
public class Driving extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(Objects.equals( data1, "NEWS" )) {
            web.loadUrl( "https://www.autocarindia.com/bike-news" );
        }
        if(Objects.equals( data1, "EVENTS" )){
            web.loadUrl( "https://www.eventshigh.com/search?city=chennai&interest=racing" );
        }
        if(Objects.equals( data1, "VIDEOS" )){
            web.loadUrl( "https://www.bcbikerace.com/media/videos/2016-videos/" );
        }
        if(Objects.equals( data1, "TUTORIALS" )){
            Intent intent = new Intent( Driving.this,Tutorial.class );
