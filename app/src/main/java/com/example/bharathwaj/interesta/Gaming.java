...
public class Gaming extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(Objects.equals( data1, "NEWS" )) {
            web.loadUrl( "https://www.gamespot.com/news/" );
        }
        if(Objects.equals( data1, "EVENTS" )){
            web.loadUrl( "https://www.eventshigh.com/chennai/gaming" );
        }
        if(Objects.equals( data1, "VIDEOS" )){
            web.loadUrl( "https://www.youtube.com/watch?v=2bEJbWCAcUQ" );
        }
        if(Objects.equals( data1, "TUTORIALS" )){
            Intent intent = new Intent( Gaming.this,Tutorial.class );
