...
public class Petcare extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(Objects.equals( data1, "NEWS" )) {
            web.loadUrl( "https://www.huffingtonpost.com/topic/pets" );
        }
        if(Objects.equals( data1, "EVENTS" )){
            web.loadUrl( "https://www.eventshigh.com/chennai/dog+show+in+chennai" );
        }
        if(Objects.equals( data1, "VIDEOS" )){
            web.loadUrl( "https://www.petfinder.com/videos/teaching-a-dog-not-to-bark-at-the-door/" );
        }
        if(Objects.equals( data1, "TUTORIALS" )){
            Intent intent = new Intent( Petcare.this,Tutorial.class );
