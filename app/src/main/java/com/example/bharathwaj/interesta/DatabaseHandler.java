...
public class DatabaseHandler extends SQLiteOpenHelper{
    ...
    public void addContacts(contactsList contact){
    ...
    public List<contactsList> getAllContacts() {
        List<contactsList> contactList = new ArrayList<contactsList>();
        // Select All Query
    ...
    public int updateContact(contactsList contact, int id) {
        SQLiteDatabase db = this.getWritableDatabase();
