...
public class Beauty extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(Objects.equals( data1, "NEWS" )) {
            web.loadUrl( "https://www.vogue.in/news/" );
        }
        if(Objects.equals( data1, "EVENTS" )){
            web.loadUrl( "http://www.vibamisschennai.com/events.php" );
        }
        if(Objects.equals( data1, "VIDEOS" )){
            web.loadUrl( "http://www.wunder2.com/video/matin" );
        }
        if(Objects.equals( data1, "TUTORIALS" )){
            Intent intent = new Intent( Beauty.this,Tutorial.class );
