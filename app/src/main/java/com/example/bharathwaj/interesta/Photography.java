...
public class Photography extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(Objects.equals( data1, "NEWS" )) {
            web.loadUrl( "https://petapixel.com/topic/news/" );
        }
        if(Objects.equals( data1, "EVENTS" )){
            web.loadUrl( "http://photocontestinformation.com/tag/free-entry/" );
        }
        if(Objects.equals( data1, "VIDEOS" )){
            web.loadUrl( "https://www.youtube.com/watch?v=9zTQIPIl3Mk" );
        }
        if(Objects.equals( data1, "TUTORIALS" )){
            Intent intent = new Intent( Photography.this,Tutorial.class );
