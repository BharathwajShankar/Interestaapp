...
public class Cricket extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(Objects.equals( data1, "NEWS" )) {
            web.loadUrl( "https://www.icc-cricket.com/news" );
        }
        if(Objects.equals( data1, "EVENTS" )){
            web.loadUrl( "https://www.eventshigh.com/chennai/cricket" );
        }
        if(Objects.equals( data1, "VIDEOS" )){
            web.loadUrl( "https://www.icc-cricket.com/video/298515" );
        }
        if(Objects.equals( data1, "TUTORIALS" )){
            Intent intent = new Intent( Cricket.this,Tutorial.class );
